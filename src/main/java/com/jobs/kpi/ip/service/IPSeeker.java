package com.jobs.kpi.ip.service;
...
import com.jobs.ip.entity.IPEntry;
import com.jobs.ip.entity.IPLocation;
import com.jobs.ip.entity.Message;
import com.jobs.kpi.constants.Constants;
import com.jobs.utils.IPUtil;
import com.jobs.utils.LogFactory;
/**
 * 
 ...
 * @Package:      [com.jobs.kpi.ip.service]
 * @ClassName:    [IPSeeker]
 * @Description:  [纯真ip的业务层]
 * @Author:       [xiaorui.lu]
 * @CreateDate:   [2014年3月21日 下午2:16:18]
 * @UpdateUser:   [xiaorui.lu]
 * @UpdateDate:   [2014年3月21日 下午2:16:18]
...
public class IPSeeker {
	// 纯真IP数据库名
	private String IP_FILE = Constants.IP_FILE;
	// 保存的文件夹
	private String INSTALL_DIR = Constants.INSTALL_DIR;
	...
	public String getCountry(byte[] ip) {
		// 检查ip地址文件是否正常
		if (ipFile == null)
			return Message.bad_ip_file + "22222";
		// 保存ip，转换ip字节数组为字符串形式
